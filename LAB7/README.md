...
```
    ...
    ##                                       1                                       1 
    ##        nordic institute of chiropractic         ontario institute of technology 
    ##                                       1                                       1 
    ##               research institute of new             the institute of biomedical 
    ##                                       4                                       1 
    ##               the institute of medicine  zoo-prophylactic institute of southern 
    ##                                       1                                       2
...
extract the abstract and article title for each one of the elements of
pub\_char\_list. You can either use sapply() as we just did, or simply
take advantage of vectorization of stringr::str\_extract
