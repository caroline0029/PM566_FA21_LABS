...
**Here is my lab output** [**here**](https://ghcdn.rawgit.org/caroline0029/PM566_FA21_Labs/main/LAB11/README.html)
...
# Inspect the range values for each variable. What is the date range? The range of cases and deaths?
knitr::kable(head(cv_states))
knitr::kable(summary(cv_states))
knitr::kable(min(cv_states$date))
knitr::kable(max(cv_states$date))
```
