...
Sum up the euclidean distance and remove the duplicates

``` r
station_averages_merge[, eudist_total:= 
  rowSums(
   cbind(
    eudist_temp_wind.sp, 
    eudist_temp_atm.press, 
    eudist_wind.sp_atm.press
), na.rm = TRUE)]
station_averages_merge %>%
  distinct()
```

    ## Source: local data table [1,595 x 17]
    ## Call:   unique(`_DT1`)
    ## 
    ##   USAFID  temp wind.sp atm.press temp_dist wind.sp_dist atm.press_dist CTRY 
    ##    <int> <dbl>   <dbl>     <dbl>     <dbl>        <dbl>          <dbl> <chr>
    ## 1 690150  33.2    3.48     1010.     9.50       1.02              4.31 US   
    ## 2 720110  31.2    2.14      NaN      7.54       0.323           NaN    US   
    ## 3 720113  23.3    2.47      NaN      0.391      0.00846         NaN    US   
    ## 4 720120  27.0    2.50      NaN      3.34       0.0429          NaN    US   
    ## 5 720137  21.9    1.98      NaN      1.80       0.483           NaN    US   
    ## 6 720151  27.6    3.00      NaN      3.89       0.537           NaN    US   
    ## # … with 1,589 more rows, and 9 more variables: STATE <chr>, temp_50 <dbl>,
...
```
    ...
    ## 1594:   US    ID 20.56798   2.568944     1012.855           4.4922623
    ## 1595:   US    ID 20.56798   2.568944     1012.855           2.9131751
    ##       eudist_temp_atm.press eudist_wind.sp_atm.press    lat eudist_total
    ##    1:            10.7480686                2.3641377 34.300   23.6771340
    ##    2:                   NaN                      NaN 30.784    1.9447578
    ##    3:                   NaN                      NaN 42.543    2.7804480
    ##    4:                   NaN                      NaN 32.224    1.4584280
    ##    5:                   NaN                      NaN 41.425    0.6019431
    ##   ---                                                                   
    ## 1591:             0.1137256                0.5343825 46.358    1.1702490
    ## 1592:             0.8041051                1.4783475 45.788    3.6261616
    ## 1593:             0.3351114                0.3152722 45.698    1.0814628
    ## 1594:             4.6068486                1.2190288 43.567   10.3181396
    ## 1595:             2.9597295                0.5559611 43.650    6.4288657

Order data frome by lat variables

``` r
station_averages_merge[order(, lat, decreasing = FALSE)]
```

    ##       USAFID     temp  wind.sp atm.press temp_dist wind.sp_dist atm.press_dist
    ##    1: 722010 29.82743 3.501355  1015.371  6.143375    1.0395168      0.6798325
    ##    2: 722015 30.57632 3.659135  1015.131  6.892265    1.1972972      0.4394969
    ##    3: 722016 29.90351 2.759356  1015.169  6.219451    0.2975182      0.4778033
    ##    4: 722026 27.84470 2.562383  1015.336  4.160645    0.1005452      0.6452656
    ##    5: 722029 28.08069 2.699017  1015.335  4.396627    0.2371788      0.6439324
    ##   ---                                                                         
    ## 1591: 720855 18.45570 3.307916       NaN  5.228357    0.8460784            NaN
    ## 1592: 720853 16.88894 4.107325       NaN  6.795120    1.6454869            NaN
    ## 1593: 720861 18.02843 4.136298       NaN  5.655630    1.6744600            NaN
    ## 1594: 722857 18.94941 3.178723       NaN  4.734646    0.7168855            NaN
    ## 1595: 726548 17.88579 3.055541       NaN  5.798270    0.5937031            NaN
    ##       CTRY STATE  temp_50 wind.sp_50 atm.press_50 eudist_temp_wind.sp
    ##    1:   US    FL 27.57325   2.705069     1015.335           2.3906981
    ##    2:   US    FL 27.57325   2.705069     1015.335           3.1509876
    ##    3:   US    FL 27.57325   2.705069     1015.335           2.3308970
    ##    4:   US    FL 27.57325   2.705069     1015.335           0.3066737
    ##    5:   US    FL 27.57325   2.705069     1015.335           0.5074765
    ##   ---                                                                
    ## 1591:   US    ND 18.52849   3.956459           NA           0.6526141
    ## 1592:   US    ND 18.52849   3.956459           NA           1.6464769
    ## 1593:   US    ND 18.52849   3.956459           NA           0.5314154
    ## 1594:   US    ND 18.52849   3.956459           NA           0.8843349
    ## 1595:   US    MN 19.63017   2.617071     1015.042           1.7986486
    ##       eudist_temp_atm.press eudist_wind.sp_atm.press    lat eudist_total
    ##    1:             2.2544744               0.79709479 24.550    5.4422672
    ##    2:             3.0100289               0.97572349 24.583    7.1367400
    ##    3:             2.3361790               0.17477404 24.726    4.8418500
    ##    4:             0.2714615               0.14269191 25.489    0.7208271
    ##    5:             0.5074404               0.00605214 25.648    1.0209691
    ##   ---                                                                   
    ## 1591:                   NaN                      NaN 48.784    0.6526141
    ## 1592:                   NaN                      NaN 48.884    1.6464769
    ## 1593:                   NaN                      NaN 48.929    0.5314154
    ## 1594:                   NaN                      NaN 48.941    0.8843349
    ## 1595:                   NaN                      NaN 48.941    1.7986486
